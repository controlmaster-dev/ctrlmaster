...
export default function ReportsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "resolved":
        return <Badge className="bg-green-700 text-green-100">Resuelto</Badge>;
      case "in-progress":
        return (
          <Badge className="bg-yellow-700 text-yellow-100">En Progreso</Badge>
        );
      case "pending":
        return <Badge className="bg-red-700 text-red-100">Pendiente</Badge>;
      default:
  ...
  const getPriorityBadge = (priority: string) => {
    switch (priority) {
      case "Enlace":
        return <Badge className="bg-red-600 text-white">Enlace</Badge>;
      case "EJTV":
        return <Badge className="bg-orange-600 text-white">EJTV</Badge>;
      case "EnlaceUSA":
        return <Badge className="bg-yellow-600 text-white">EnlaceUSA</Badge>;
      case "Todos":
        return <Badge className="bg-green-600 text-white">Todos</Badge>;
      default:
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-300">
              Gestión de reportes de incidentes técnicos
            </p>
          </div>
        </div>
