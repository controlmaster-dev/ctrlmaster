...
export default function ReportsPage() {
  ...
  return (
    _jsxs("div", { className: "space-y-6 p-4 pt-20", children: [

      _jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white", children: [
        _jsxs("div", { className: "flex items-center space-x-4", children: [
          _jsx(Link, { href: "/", children:
            _jsxs(Button, { variant: "outline", size: "sm", className: "border-white/20 text-white hover:bg-white/10", children: [
        ...
        _jsx(Link, { href: "/create-report", children:
          _jsxs(Button, { className: "bg-gradient-to-r from-[#FF0C60] to-[#FF0C60]/80 hover:from-[#FF0C60]/90 hover:to-[#FF0C60]/70 text-white shadow-xl shadow-[#FF0C60]/25 hover:shadow-2xl hover:shadow-[#FF0C60]/40 transform hover:scale-[1.02] transition-all duration-300", children: [
      ...
      _jsxs(Card, { className: `${glassCard}`, children: [
        _jsx(CardHeader, { children:
          _jsxs(CardTitle, { className: "flex items-center space-x-2", children: [
            _jsx(Filter, { className: "w-5 h-5" }), " ", _jsx("span", { children: "Filtros" })] }
          ) }
        ),
        _jsx(CardContent, { children:
          _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4", children: [
            ...
            _jsxs(Select, { value: statusFilter, onValueChange: setStatusFilter, children: [
              _jsx(SelectTrigger, { className: "bg-white/0 backdrop-blur-3xl text-white border border-white/20", children:
                _jsx(SelectValue, { placeholder: "Estado" }) }
              ),
              _jsxs(SelectContent, { className: "bg-white/0 backdrop-blur-3xl text-white border border-white/20", children: [
            ...
            _jsxs(Select, { value: priorityFilter, onValueChange: setPriorityFilter, children: [
              _jsx(SelectTrigger, { className: "bg-white/0 backdrop-blur-3xl text-white border border-white/20", children:
            ...
            _jsxs(Select, { value: categoryFilter, onValueChange: setCategoryFilter, children: [
              _jsx(SelectTrigger, { className: "bg-white/0 backdrop-blur-3xl text-white border border-white/20", children:
      ...
      _jsxs(Card, { className: `${glassCard}`, children: [
        ...
        _jsx(CardContent, { children:
          ...
          _jsx("div", { className: "overflow-x-auto", children:
            _jsxs(Table, { className: "bg-white/0 backdrop-blur-3xl text-white border border-white/20", children: [
              ...
              _jsx(TableBody, { children:
                ...
                _jsxs(TableRow, { children: [
                  ...
                  _jsx(TableCell, { children:
                    _jsx(Button, { variant: "ghost", size: "sm", className: "text-white hover:text-white", onClick: () => downloadPDF(report), children:
          ...
          _jsxs("div", { className: "text-center py-8", children: [
            ...
            _jsx("p", { className: "text-gray-300 mb-4", children:
              reports.length === 0 ?
