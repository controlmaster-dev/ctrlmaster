...
export async function GET() {
    ...
    try {
        ...
        if (YOUTUBE_API_KEY) {
            // Use official YouTube Data API v3 (reliable method)
            try {
                // Method 1: Try search with eventType=live
                ...
                if (ytRes.ok) {
                    ...
                    if (data.error) {
                        ...
                        // Method 2: Fallback - get recent videos and check liveBroadcastContent
                        ...
                        if (ytRes.ok) {
                            ...
                            if (recentData.items && recentData.items.length > 0) {
                                // Check if any recent video has liveBroadcastContent = "live"
            ...
            // Fallback: Check for manual override in environment
