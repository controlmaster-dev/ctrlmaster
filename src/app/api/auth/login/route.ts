                ...
                html: `
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .container { max-width: 600px; width: 100%; margin: 0 auto; background-color: #000000 !important; border-radius: 16px; overflow: hidden; border: 1px solid #27272a; }
                            ...
                            .data-label { padding: 10px 0; color: #94a3b8; font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px; width: 110px; text-align: left; }
                        ...
                        <table class="outer-wrapper" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000000" style="table-layout: fixed;">
                            <tr>
                                <td align="center" class="outer-padding" style="padding: 40px 10px;">
                                    <table class="container" width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#000000" style="max-width: 600px; width: 100%; border-radius: 16px; border: 1px solid #27272a;">
                                        <tr>
                                            <td>
