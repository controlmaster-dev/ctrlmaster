        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-zinc-500 text-base md:text-lg font-normal max-w-md mx-auto leading-relaxed">
              La página que solicitaste no está disponible o no existe en el
              sistema.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link href="/" passHref className="w-full sm:w-auto">
              <Button className="w-full sm:w-auto min-w-[140px] bg-zinc-100 text-black hover:bg-zinc-200 border border-zinc-200 rounded-full flex items-center justify-center gap-2 h-12 px-8 transition-all hover:scale-105 active:scale-95 font-semibold">
