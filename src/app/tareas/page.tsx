...
function OperatorView({ user }: { user: any }) {
    ...
    const getDayName = (d: Date) => format(d, 'EEE', { locale: es }).replace('.', '')
                                                        ...
                                                        {weekDays.map(d => {
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    `}
                                                                >
                                                                    <span className="text-[9px] opacity-70 mb-0.5">{format(d, 'EEE', { locale: es })}</span>
                                    ...
                                    {newTasks.map((t, idx) => (
                                        <div key={idx} className="flex gap-2 items-start">
                                            ...
                                            <div className="grid gap-1 w-28">
                                                <Label className="text-[10px] text-slate-400">Prioridad</Label>
