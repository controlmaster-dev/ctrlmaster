...
export function DashboardClient() {
  ...
  return (
    _jsxs("div", { className: "min-h-screen relative overflow-hidden text-foreground selection:bg-[#FF0C60] selection:text-white pb-20", children: [
      ...
      _jsx(motion.div, {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        className: "relative z-10 max-w-[1600px] mx-auto space-y-4 md:space-y-8 p-4 md:p-8 pt-20 md:pt-32", children:
        ...
        _jsx(AnimatePresence, { mode: "wait", children:
          ...
          _jsxs(motion.div, {
            ...
            _jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-end w-full gap-8 py-12 border-b border-border bg-muted/5 rounded-md p-6 md:p-12", children: [
              _jsxs("div", { className: "space-y-4 max-w-3xl w-full", children: [
                _jsx("div", { className: "h-16 w-3/4 bg-muted rounded-md" }),
                _jsx("div", { className: "h-4 w-1/2 bg-muted rounded-md" })] }
              ),
              _jsxs("div", { className: "flex flex-col gap-4 w-full md:w-auto", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-6", children: [
              Array(3).fill(0).map((_, i) =>
              _jsxs("div", { className: "h-[140px] rounded-md bg-card/40 border border-border p-5 space-y-4", children: [
              ...
              _jsxs("div", { className: "h-[140px] rounded-md bg-card/40 border border-border p-5 flex flex-col justify-between", children: [
                _jsx("div", { className: "h-8 w-8 rounded-md bg-muted" }),
                _jsxs("div", { className: "space-y-2", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-10", children: [
              _jsx("div", { className: "lg:col-span-2 space-y-10", children:
                _jsxs("div", { className: "rounded-md border border-border bg-card/40 backdrop-blur-sm overflow-hidden", children: [
                  _jsxs("div", { className: "p-6 border-b border-border space-y-2", children: [
                    _jsx("div", { className: "h-6 w-48 bg-muted rounded" }),
                    _jsx("div", { className: "h-3 w-64 bg-muted rounded opacity-50" })] }
                  ),
                  _jsx("div", { className: "p-0", children:
                    Array(5).fill(0).map((_, i) =>
                    _jsxs("div", { className: "flex items-center gap-6 p-6 border-b border-border last:border-0", children: [
                      ...
                      _jsx("div", { className: "w-24 h-6 rounded-md bg-muted opacity-40" })] }, i
                    )
                    ) }
                  )] }
                ) }
          ...
          _jsxs(motion.div, {
            ...
            _jsxs("div", { className: "relative z-10 flex flex-col items-start gap-6 md:gap-8 py-6 md:py-12 border-b border-border bg-card/50 backdrop-blur-sm rounded-md p-6 md:p-12 overflow-hidden ring-1 ring-border", children: [
              _jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background via-transparent to-transparent pointer-events-none" }),

              _jsxs("div", { className: "relative flex flex-col md:flex-row justify-between items-start md:items-end w-full gap-6 md:gap-8", children: [
                _jsxs("div", { className: "space-y-3 md:space-y-4 max-w-3xl w-full", children: [
                  _jsx("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-bold text-foreground tracking-tight leading-tight", children:
                ...
                _jsxs("div", { className: "flex flex-col items-stretch md:items-end gap-4 w-full md:w-auto", children: [
                  _jsxs("div", { className: "grid grid-cols-2 md:flex gap-3 md:gap-4", children: [
                    _jsxs(Link, { href: "/operadores/monitoreo", className: "relative group", children: [
                      ...
                      _jsxs(Button, { variant: "outline", className: "w-full h-12 md:px-6 border-border bg-card text-muted-foreground hover:text-cyan-400 rounded-md gap-2 md:gap-3 backdrop-blur-md transition-all group-hover:border-cyan-500/30 group-hover:scale-105 active:scale-95", children: [
                    ...
                    _jsxs(Link, { href: "/operadores", className: "relative group", children: [
                      ...
                      _jsxs(Button, { variant: "outline", className: "w-full h-12 md:px-6 border-border bg-card text-muted-foreground hover:text-violet-400 rounded-md gap-2 md:gap-3 backdrop-blur-md transition-all group-hover:border-violet-500/30 group-hover:scale-105 active:scale-95", children: [
                  ...
                  _jsxs("div", { className: "flex items-center gap-3 w-full", children: [
                    _jsxs(Link, { href: "/crear-reporte", className: "flex-1 relative group", children: [
                      ...
                      _jsxs(Button, { className: "w-full h-12 md:h-14 px-8 bg-gradient-to-r from-[#FF0C60] to-[#FF0080] hover:from-[#FF2E75] hover:to-[#FF1A8C] text-white rounded-md border-0 shadow-lg shadow-rose-500/20 gap-3 text-base md:text-lg font-bold tracking-tight transition-all hover:scale-[1.02] active:scale-95", children: [
                    ...
                    _jsx(TooltipProvider, { children:
                      _jsxs(Tooltip, { children: [
                        _jsx(TooltipTrigger, { asChild: true, children:
                          _jsxs(motion.a, {
                            ...
                            _jsx(Button, {
                              ...
                              _jsxs(motion.div, { className: "flex items-center", children: [
                        ...
                        _jsx(TooltipContent, { side: "top", className: "bg-cyan-500 border-cyan-400 text-[#0f172a] font-bold", children:
            ...
            _jsx("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-3 md:gap-6", children:
              loadingReports ?
              _jsxs(_Fragment, { children: [
                [0, 1, 2].map((i) =>
                _jsxs("div", { className: "rounded-md border border-border bg-card/50 p-4 md:p-5 space-y-4 animate-pulse", children: [
            ...
            currentUser?.role === 'ENGINEER' &&
            _jsx("div", { className: "w-full", children:
              _jsxs(Card, { className: "bg-card backdrop-blur-md md:backdrop-blur-xl border border-border shadow-sm overflow-hidden rounded-md ring-1 ring-border", children: [
                _jsxs(CardHeader, { children: [
                  _jsxs(CardTitle, { className: "text-xl text-foreground flex items-center gap-2 font-bold tracking-tight", children: [
                ...
                _jsx(CardContent, { children:
                  _jsx("div", { className: "h-[220px] w-full p-4 flex flex-col justify-between relative group", children:
                    loadingReports ?
                    _jsx("div", { className: "w-full h-full flex items-end justify-between gap-2", children:
                    ...
                    _jsxs(_Fragment, { children: [
                      _jsxs("div", { className: "absolute inset-x-4 top-4 bottom-10", children: [
                        _jsxs("svg", { className: "w-full h-full overflow-visible", preserveAspectRatio: "none", viewBox: "0 0 100 100", children: [
                          _jsx("defs", { children:
                            _jsxs("linearGradient", { id: "lineGradient", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                        ...
                        chartData.values.map((val, i) => {
                          ...
                          return (
                            _jsxs("div", {
                              ...
                              _jsx("div", { className: "absolute bottom-full mb-2 bg-card text-cyan-400 text-[10px] font-bold px-2 py-0.5 rounded border border-cyan-500/30 opacity-0 group-hover/point:opacity-100 transition-opacity whitespace-nowrap pointer-events-none", children:
                                val }
                              )] }, i
                            ));
                      ...
                      _jsx("div", { className: "absolute bottom-2 left-4 right-4 flex justify-between text-[10px] font-semibold text-muted-foreground", children:
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-10", children: [
              _jsx("div", { className: "lg:col-span-2 space-y-10", children:
                _jsx("div", { children:
                  _jsxs(Card, { className: "bg-card backdrop-blur-md md:backdrop-blur-xl border border-border shadow-sm overflow-hidden rounded-md group ring-1 ring-border", children: [
                    _jsxs(CardHeader, { className: "border-b border-border flex flex-row items-center justify-between p-6 relative", children: [
                      _jsxs("div", { children: [
                      ...
                      _jsx(Link, { href: "/reportes", children:
                        _jsxs(Button, { variant: "ghost", className: "text-[#FF0C60] hover:text-[#FF0C60] hover:bg-[#FF0C60]/10 rounded-md px-4 text-xs font-bold h-8 transition-all", children: ["Ver Todos ",
                          _jsx(ArrowUpRight, { className: "ml-2 w-3 h-3" })] }
                        ) }
                      )] }
                    ),
                    _jsx(CardContent, { className: "p-0 overflow-x-auto", children:
                      loadingReports ?
                      _jsx("div", { className: "p-0 space-y-0 animate-pulse", children:
                        [1, 2, 3, 4, 5].map((i) =>
                        _jsxs("div", { className: "flex gap-6 items-center p-6 border-b border-border last:border-0", children: [
                          _jsx("div", { className: "w-16 h-3 bg-muted rounded" }),
                          _jsxs("div", { className: "space-y-3 flex-1", children: [
                          ...
                          _jsx("div", { className: "w-20 h-6 rounded-md bg-muted" })] }, i
                        )
                        ) }
                      ) :

                      recentReports.length > 0 ?
                      _jsx("div", { className: "min-w-[600px]", children:
                        _jsxs(Table, { children: [
                          _jsx(TableHeader, { className: "bg-muted/10", children:
                            _jsxs(TableRow, { className: "border-border hover:bg-transparent", children: [
                          ...
                          _jsx(TableBody, { children:
                            ...
                            _jsxs(TableRow, { className: "border-border hover:bg-muted/10 transition-all group/row", children: [
                              _jsxs(TableCell, { className: "font-mono text-xs text-muted-foreground pl-6 py-4", children: [
                                _jsx("span", { className: "opacity-50", children: "#" }), report.id.slice(0, 6)] }
                              ),
                              _jsx(TableCell, { className: "py-4", children:
                                _jsxs("div", { className: "flex flex-col gap-2", children: [
                                  _jsx("div", { className: "font-semibold text-foreground text-sm line-clamp-1 pr-4 tracking-tight", children:
                                    report.problemDescription }
                                  ),
                                  _jsxs("div", { className: "flex items-center gap-3", children: [
                                    _jsxs("div", { className: "flex items-center gap-2", children: [
                                      _jsx("div", { className: "w-5 h-5 rounded-full bg-muted flex items-center justify-center text-[9px] font-bold text-muted-foreground border border-border", children:
                                    ...
                                    _jsx(Badge, { variant: "outline", className: `text-[9px] px-2 py-0 border rounded-full font-bold tracking-tight ${report.priority === 'Enlace' ? 'bg-indigo-500/10 text-indigo-400 border-indigo-500/20' : report.priority === 'EJTV' ? 'bg-[#FF0C60]/10 text-[#FF0C60] border-[#FF0C60]/20' : 'bg-muted text-muted-foreground border-border'}`, children:
                                      report.priority }
                                    )] }
                                  )] }
                                ) }
                              ...
                              _jsx(TableCell, { className: "pr-6 py-4 text-right", children:
                                _jsx("div", { className: "flex justify-end items-center gap-1 opacity-0 group-hover/row:opacity-100 transition-opacity", children:
                                  report.status !== 'resolved' &&
                                  _jsx(Button, { size: "icon", variant: "ghost", onClick: (e) => handleResolve(report.id, e), className: "h-8 w-8 text-emerald-500 hover:text-white hover:bg-emerald-500 rounded-full transition-all shadow-lg hover:shadow-emerald-500/20", title: "Resolver", children:
                      ...
                      _jsxs("div", { className: "py-16 text-center text-muted-foreground font-medium", children: [
              ...
              _jsx("div", { className: "lg:col-span-1", children:
                _jsx("div", { children:
                  loadingUsers ?
                  _jsxs(Card, { className: "bg-card backdrop-blur-xl border-border shadow-sm overflow-hidden ring-1 ring-border h-[600px] flex flex-col", children: [
                    _jsx(CardHeader, { className: "p-4 border-b border-border flex flex-row items-center justify-between space-y-0 shrink-0", children:
                      _jsxs("div", { className: "flex items-center gap-3", children: [
                        _jsx(Skeleton, { className: "h-8 w-8 rounded-md bg-muted" }),
                        _jsx(Skeleton, { className: "h-4 w-3/32 bg-muted" })] }
                      ) }
                    ),
                    _jsx(CardContent, { className: "p-0 flex-1 flex flex-col", children:
                      Array(7).fill(0).map((_, i) =>
                      _jsxs("div", { className: "flex items-center gap-3 p-3 border-l-[3px] border-transparent", children: [
                        _jsxs("div", { className: "flex flex-col items-center justify-center w-12 shrink-0 gap-1", children: [
                        ...
                        _jsxs("div", { className: "flex-1 flex items-center gap-3", children: [
                          ...
                          _jsxs("div", { className: "space-y-1.5 flex-1", children: [
...
function LiveActivityCard({ comments, loading }) {
  ...
  return (
    _jsx(Card, { className: "border-border bg-card/40 backdrop-blur-sm border transition-all duration-300 hover:border-[#FF0C60]/30 rounded-md overflow-hidden group", children:
      _jsxs(CardContent, { className: "p-4 md:p-5 h-full flex flex-col justify-between", children: [
        _jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          ...
          _jsxs("span", { className: "flex h-2 w-2 relative", children: [
        ...
        _jsxs("div", { className: "space-y-1.5 flex-1 min-w-0", children: [
          ...
          _jsxs("div", { className: "space-y-2", children: [
            ...
            _jsxs("div", { className: "flex items-center justify-between mt-auto pt-1", children: [
...
function StatsCard({ title, value, subtitle, icon, valueColor = "text-foreground", variant = 'default' }) {
  ...
  return (
    _jsx(Card, { className: `${variants[variant]} backdrop-blur-sm border transition-all duration-200 hover:border-opacity-50 rounded-md overflow-hidden`, children:
      _jsxs(CardContent, { className: "p-4 md:p-5", children: [
