...
export default function CreateReport() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const operator = usersData.users.find(
        (user) => user.email === formData.operatorEmail
      );
      if (!operator)
        throw new Error("Email de operador no encontrado en el sistema");
  ...
  const generateReportId = () =>
    `RPT-${Date.now()}-${Math.random().toString(36).substr(2, 6).toUpperCase()}`;

  const glassBg =
    "bg-white/5 backdrop-blur-3xl border border-white/10 shadow-lg shadow-black/20 rounded-2xl";
        ...
        >
          <Link href="/">
            <Button
              variant="outline"
              size="sm"
              className="border-white/10 text-white hover:bg-white/5 hover:text-white bg-transparent transition-colors"
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("operatorEmail", value)
                      }
                    >
                    ...
                    >
                      ...
                      <SelectContent className="bg-[#1a1a1a] border-white/10 text-white">
                        ...
                        <SelectItem
                          ...
                          className="focus:bg-white/10 focus:text-white cursor-pointer"
                        >
                          Todos (Enlace USA, Enlace, EJTV y EnlaceCR)
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                    ...
                    >
                      ...
                      <SelectContent className="bg-[#1a1a1a] border-white/10 text-white">
                        ...
                        <SelectItem
                          ...
                          className="focus:bg-white/10 focus:text-white cursor-pointer"
                        >
                          Caída de Servidores Bitcentral
                        </SelectItem>
                        <SelectItem
                          value="Falla Energética"
                          className="focus:bg-white/10 focus:text-white cursor-pointer"
                        >
                          Falla Energética
                        </SelectItem>
                  ...
                  <div className="space-y-2">
                    <Label
                      ...
                      className="text-white/80 font-medium"
                    >
                      Fecha del Problema <span className="text-red-400">*</span>
                    </Label>
                    <Input
                      id="dateStarted"
                      type="datetime-local"
                ...
                <div className="space-y-4 p-6 bg-white/5 rounded-2xl border border-white/10">
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("isResolved", e.target.checked)
                      }
                      ...
                      >
                        <div className="space-y-2 pt-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleInputChange("dateResolved", e.target.value)
                            }
                ...
                <div className="flex justify-end space-x-4 pt-4">
                  <Link href="/">
                    <Button
                      variant="outline"
                      disabled={loading}
                      className="border-white/10 text-white hover:bg-white/5 hover:text-white bg-transparent h-12 px-6 rounded-xl transition-all"
                    >
                      Cancelar
                    </Button>
                  </Link>
