...
export default function UsersPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#050505] text-slate-100 selection:bg-[#FF0C60] selection:text-white pb-20">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8 pt-20 md:pt-6 space-y-8 relative z-10">
        <motion.div
              ...
              <Table>
                <TableHeader className="bg-slate-50 dark:bg-white/5 border-b border-slate-200 dark:border-white/5">
                  <TableRow className="border-none hover:bg-transparent">
                    <TableHead className="text-slate-500 dark:text-slate-400 h-12 pl-6">
                      Usuario
                    </TableHead>
                    <TableHead className="text-slate-500 dark:text-slate-400 h-12">
                      Rol
                    </TableHead>
                    <TableHead className="text-slate-500 dark:text-slate-400 h-12">
                      Horario
                    ...
                    <TableHead className="text-slate-500 dark:text-slate-400 h-12 text-right pr-6">
                      Acciones
                    </TableHead>
                  </TableRow>
                </TableHeader>
                          ...
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button
                                variant="ghost"
                                size="icon"
                                className="h-8 w-8 text-slate-400 hover:text-white hover:bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity"
                              >
                            ...
                            <DropdownMenuContent
                              align="end"
                              className="bg-white dark:bg-[#18181B] border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 shadow-xl"
                            >
                              <DropdownMenuItem
                                disabled
