...
export default function UsersPage() {
  ...
  return (
    _jsxs("div", {
      className: "min-h-screen relative overflow-hidden bg-[#050505] text-slate-100 selection:bg-[#FF0C60] selection:text-white pb-20", children: [
        ...
        _jsxs("div", {
          className: "max-w-7xl mx-auto p-4 md:p-8 pt-20 md:pt-6 space-y-8 relative z-10", children: [


            _jsx(motion.div, {
              initial: { opacity: 0, y: -10 }, animate: { opacity: 1, y: 0 }, className: "flex flex-col md:flex-row justify-between items-start md:items-center gap-4", children:
                _jsxs("div", {
                  children: [
                    _jsxs("h1", {
                      className: "text-3xl font-bold text-slate-900 dark:text-white flex items-center gap-3", children: ["Usuarios",

                        _jsx(Badge, { className: "bg-[#FF0C60]/10 text-[#FF0C60] hover:bg-[#FF0C60]/20 border-0", children: users.length })]
                    }
                    ),
                    _jsxs("p", {
                      className: "text-slate-500 dark:text-slate-400", children: ["Administraci\xF3n de personal. ",
            ...
            _jsx(motion.div, {
              initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.1 }, children:
                _jsx(Card, {
                  className: "bg-white/80 dark:bg-[#0F0F11]/80 backdrop-blur-md border-slate-200 dark:border-white/5 shadow-xl", children:
                    _jsx(CardContent, {
                      className: "pt-6", children:
                        _jsxs("div", {
                          className: "relative max-w-lg", children: [
            ...
            _jsx(motion.div, {
              initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.1 }, children:
                _jsx(Card, {
                  className: "bg-[#121214]/60 backdrop-blur-xl border-white/5 shadow-2xl overflow-hidden rounded-3xl", children:
                    _jsx(CardContent, {
                      className: "p-0", children:
                        _jsxs(Table, {
                          children: [
                            _jsx(TableHeader, {
                              className: "bg-slate-50 dark:bg-white/5 border-b border-slate-200 dark:border-white/5", children:
                                _jsxs(TableRow, {
                                ...
                                loading ?
                                  ...
                                  filteredUsers.length === 0 ?
                                    ...
                                    filteredUsers.map((user) =>
                                      _jsxs(TableRow, {
                                        className: "border-b border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors group", children: [
                                          _jsx(TableCell, {
                                            className: "pl-6 py-3", children:
                                              _jsxs("div", {
                                                className: "flex items-center gap-3", children: [
                                                  _jsxs(Avatar, {
                                                    className: "w-9 h-9 border border-slate-200 dark:border-white/10", children: [
                                                      _jsx(AvatarImage, { src: user.image }),
                                                      _jsx(AvatarFallback, {
                                                        className: "bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-slate-300 font-medium", children:
                                                          user.name.charAt(0)
                                                      }
                                                      )]
                                                  }
                                                  ...
                                                  _jsxs("div", {
                                                    className: "flex flex-col", children: [
                                                      ...
                                                      _jsxs("span", {
                                                        className: "text-xs text-slate-500 dark:text-slate-500 flex items-center gap-1", children: [
                                          ...
                                          _jsx(TableCell, {
                                            children:
                                              _jsxs(Badge, {
                                                variant: "outline", className: `font-normal ${user.role === 'BOSS' ? 'bg-[#FF0C60]/10 text-[#FF0C60] border-[#FF0C60]/20' : 'bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-white/10'}`, children: [
                                          ...
                                          _jsx(TableCell, {
                                            children:
                                              _jsx("span", {
                                                className: "text-xs text-slate-500 dark:text-slate-400 font-medium", children:
                                          ...
                                          _jsx(TableCell, {
                                            children:
                                              user.isAvailable ?
                                                _jsxs("div", {
                                                  className: "flex items-center gap-2 px-2 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-md w-fit", children: [
                                                ...
                                                _jsxs("div", {
                                                  className: "flex items-center gap-2 px-2 py-1 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-md w-fit opacity-60", children: [
                                          ...
                                          _jsx(TableCell, {
                                            className: "text-right pr-6", children:
                                              _jsxs(DropdownMenu, {
                                                children: [
                                                  _jsx(DropdownMenuTrigger, {
                                                    asChild: true, children:
                                                      _jsx(Button, {
                                                        variant: "ghost", size: "icon", className: "h-8 w-8 text-slate-400 hover:text-white hover:bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity", children:
                                                  ...
                                                  _jsx(DropdownMenuContent, {
                                                    align: "end", className: "bg-white dark:bg-[#18181B] border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 shadow-xl", children:
