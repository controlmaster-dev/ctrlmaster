...
export default function ProgramValidatorPage() {
  ...
  return (
    ...
    _jsxs("div", {
      className: "min-h-screen w-full bg-background text-foreground flex flex-col font-sans selection:bg-[#FF0C60] selection:text-white pt-20 md:pt-6 px-4 md:px-8 pb-6 max-w-[1800px] mx-auto gap-6", children: [


        _jsxs("header", {
          className: "flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shrink-0", children: [
            _jsxs("div", {
              className: "flex items-center gap-4", children: [
                _jsx("div", {
                  className: "w-10 h-10 bg-[#FF0C60] rounded-md shadow-lg shadow-[#FF0C60]/20 flex items-center justify-center text-white", children:
                ...
                _jsxs("div", {
                  children: [
                    ...
                    _jsxs("p", {
                      className: "text-xs text-muted-foreground font-medium flex items-center gap-2", children: [
            ...
            stats.total > 0 &&
            _jsxs("div", {
              className: "flex items-center gap-1 bg-card border border-border px-4 py-2 rounded-full shadow-sm animate-in slide-in-from-right-4 fade-in", children: [
            ...
            _jsx("div", {
              className: "flex gap-2", children:
                _jsxs("button", {
                  onClick: () => setShowKb(true), className: "flex items-center gap-2 px-4 py-2 text-xs font-semibold bg-card hover:bg-muted border border-border rounded-md transition-all shadow-sm", children: [
        ...
        _jsxs("main", {
          className: "flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-[600px]", children: [


            _jsxs("section", {
              className: "col-span-1 lg:col-span-5 flex flex-col bg-card border border-border rounded-xl overflow-hidden shadow-sm ring-1 ring-border relative group transition-all hover:shadow-md", children: [

                _jsxs("div", {
                  className: "h-12 border-b border-border bg-muted/20 flex items-center justify-between px-4", children: [
                    _jsxs("div", {
                      className: "flex items-center gap-2 text-xs font-bold text-muted-foreground uppercase tracking-wider", children: [
                        _jsx(Terminal, { className: "w-4 h-4" }), "Entrada de Datos"]
                    }

                    ),
                    _jsxs("button", {
                      onClick: handleClear, className: "text-[10px] text-muted-foreground hover:text-rose-500 transition-colors uppercase font-bold tracking-wider flex items-center gap-1.5 px-2 py-1 hover:bg-rose-500/10 rounded", children: [
                ...
                _jsxs("div", {
                  className: "flex-1 relative", children: [
                    _jsx("textarea", {
                      value: input,
                    ...
                    _jsx("div", {
                      className: "absolute bottom-6 right-6 z-10", children:
                        _jsxs("button", {
                          ...
                          className: "bg-[#FF0C60] hover:bg-[#D40050] text-white pl-4 pr-6 py-3 rounded-full shadow-lg hover:shadow-xl hover:shadow-[#FF0C60]/30 transition-all flex items-center gap-3 font-bold tracking-wide group active:scale-95", children: [
                            ...
                            _jsx("div", {
                              className: "w-8 h-8 rounded-full bg-white/20 flex items-center justify-center group-hover:rotate-90 transition-transform duration-500", children:
            ...
            _jsxs("section", {
              className: "col-span-1 lg:col-span-7 flex flex-col bg-card border border-border rounded-xl overflow-hidden shadow-sm ring-1 ring-border h-full", children: [
                _jsxs("div", {
                  className: "h-12 border-b border-border bg-muted/20 flex items-center justify-between px-4", children: [
                    _jsxs("div", {
                      className: "flex items-center gap-2 text-xs font-bold text-muted-foreground uppercase tracking-wider", children: [
                    ...
                    _jsxs("button", {
                      onClick: copyToClipboard, className: "text-[10px] text-muted-foreground hover:text-blue-500 transition-colors uppercase font-bold tracking-wider flex items-center gap-1.5 px-2 py-1 hover:bg-blue-500/10 rounded", children: [
                ...
                _jsx("div", {
                  className: "flex-1 overflow-y-auto custom-scrollbar p-6 bg-muted/5 relative", children:
                    processedDays.length === 0 ?
                      _jsxs("div", {
                        className: "absolute inset-0 flex flex-col items-center justify-center opacity-30 select-none gap-4", children: [
                          _jsx("div", {
                            className: "w-20 h-20 bg-muted rounded-full flex items-center justify-center", children:
                      ...
                      _jsx("div", {
                        className: "space-y-8 pb-10", children:
                          processedDays.map((day, i) =>
                            _jsxs("div", {
                              className: "animate-in fade-in slide-in-from-bottom-2 duration-500", style: { animationDelay: `${i * 100}ms` }, children: [

                                _jsxs("div", {
                                  className: "flex items-center gap-3 mb-3 sticky top-0 bg-background/95 backdrop-blur-sm py-3 z-10 border-b border-border/50 shadow-sm -mx-2 px-2", children: [
              ...
              className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4", children:
                ...
                _jsxs(motion.div, {
                  ...
                  className: "bg-card w-full max-w-2xl border border-border shadow-2xl rounded-lg flex flex-col max-h-[85vh] overflow-hidden", children: [
                    ...
                    _jsxs("header", {
                      className: "h-14 border-b border-border flex items-center justify-between px-6 bg-muted/20", children: [
                        _jsxs("span", {
                          className: "text-sm font-bold flex items-center gap-2", children: [
                    ...
                    _jsx("div", {
                      className: "bg-blue-500/5 px-6 py-4 border-b border-blue-500/10", children:
                        _jsxs("p", {
                          className: "text-xs text-muted-foreground leading-relaxed", children: [
                    ...
                    _jsxs("footer", {
                      className: "p-4 border-t border-border bg-muted/10 flex justify-end gap-3", children: [
...
function StatItem({ label, value, color = "text-foreground" }) {
  return (
    _jsxs("div", {
      className: "px-3 flex flex-col items-center min-w-[70px]", children: [
  ...
  return (
    _jsxs("div", {
      className: cn(
        ...
        _jsx("div", {
          className: cn("w-8 h-8 rounded-md flex items-center justify-center shrink-0 mt-0.5", config.bg), children:
        ...
        _jsxs("div", {
          className: "flex-1 min-w-0", children: [
            ...
            _jsxs("div", {
              className: "flex justify-between items-center mb-0.5", children: [
                _jsx("span", {
                  className: cn("font-mono text-sm font-bold tracking-tight", config.color), children:
                    program.code
                }
                ),
                _jsx("span", {
                  className: cn("text-[9px] font-bold uppercase tracking-wider opacity-60", config.color), children:
                    config.label
                }
                )]
            }
            ...
            program.reason &&
            _jsx("div", {
              className: "text-[10px] text-muted-foreground font-medium leading-tight opacity-80 mt-1", children:
                program.reason
            }
            )]
        }
