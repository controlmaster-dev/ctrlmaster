...
export default function UsersPage() {
  ...
  const glassCard =
    "bg-white/0 backdrop-blur-3xl border border-white/20 shadow-lg shadow-white/10 rounded-2xl";
    ...
    >
      <div className="space-y-6 max-w-7xl mx-auto text-white">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-300">
              Equipo de trabajo de Enlace Canal 23
            </p>
          </div>
        </div>
        ...
        <Card className={`${glassCard} text-white`}>
          <CardHeader>
            <CardTitle>
              Perfiles Activos para crear un reporte para Control Máster.
            </CardTitle>
          </CardHeader>
          <CardContent>
