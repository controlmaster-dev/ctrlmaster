...
export function MonitoreoClient() {
  ...
  return (
    _jsxs("div", { className: "flex flex-col min-h-screen bg-background text-muted-foreground pt-14 md:pt-0 overflow-y-auto transition-colors duration-500 relative", children: [
      ...
      _jsxs("div", { className: "h-10 md:h-12 bg-card/40 backdrop-blur-xl border-b border-border/60 flex items-center justify-between px-2 md:px-5 shrink-0 relative z-10", children: [
        _jsxs("div", { className: "flex items-center gap-2 md:gap-4", children: [
          _jsx(Link, { href: "/", children:
            _jsx(Button, { variant: "ghost", size: "icon", className: "h-6 w-6 text-muted-foreground hover:text-foreground hover:bg-muted", children:
          ...
          _jsxs("span", { className: "hidden md:inline-block text-[9px] text-muted-foreground/70 bg-muted/40 px-2 py-0.5 rounded-sm border border-border/40 uppercase font-medium tracking-wide", children: ["PULSAR ",
        ...
        _jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          _jsxs(Dialog, { children: [
            _jsx(DialogTrigger, { asChild: true, children:
              _jsxs(Button, { variant: "ghost", size: "sm", className: "h-8 gap-2 text-[10px] font-medium tracking-widest hover:bg-muted text-muted-foreground hover:text-foreground transition-all bg-card/50 border border-border/50 rounded-md uppercase", children: [
                _jsx(Activity, { className: "w-3.5 h-3.5 text-primary/70" }),
                _jsx("span", { className: "hidden md:inline", children: "Estado del Sistema" })] }
              ) }
            ),
            _jsx(DialogContent, { className: "max-w-6xl bg-black/40 backdrop-blur-3xl border-white/10 text-white p-0 overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)] rounded-3xl", children:
      ...
      _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-2 p-2 shrink-0", children: [
        _jsxs("div", {
          ...
          _jsx("div", { className: "absolute inset-0 bg-green-500/0 group-hover/master:bg-green-500/5 transition-colors z-50 flex items-center justify-center pointer-events-none", children:
        ...
        _jsx("div", { className: "relative bg-black overflow-hidden aspect-video ring-1 ring-border", children:
          _jsx(VideoJSPlayer, {
      ...
      _jsx("div", { className: "flex-1 bg-background p-2 pt-0 grid grid-cols-2 md:grid-cols-4 gap-2", children:
        Array.from({ length: 8 }).map((_, i) => {
          ...
          return (
            _jsx("div", {
              ...
              _jsx("div", { className: "w-full h-full flex items-center justify-center border-2 border-dashed border-border/20 bg-muted/10 rounded-sm", children:
