          ...
          <div className="flex justify-between items-start gap-2">
            ...
            <div className="flex gap-1 shrink-0">
              {task.reminderSent && !isCompleted && (
                <Badge
                  variant="outline"
                  className="text-[10px] h-5 px-2 bg-orange-50 text-orange-700 border-orange-200 dark:bg-orange-900/20 dark:text-orange-400 dark:border-orange-800"
                >
              ...
              {!isCompleted && task.deadline && (
                <Badge
                  variant="secondary"
                  className="text-[10px] h-5 px-1.5 font-mono bg-slate-100 dark:bg-white/10 text-slate-500"
                >
                  {task.deadline}
                </Badge>
              )}
