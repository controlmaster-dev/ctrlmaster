          ...
          className: isIntegrated ?
            ...
            "fixed inset-0 z-[20000] flex items-start justify-center md:pt-[15vh] px-0 md:px-4", children: [
              ...
              _jsxs(motion.div, {
                ...
                className: `relative w-full border-x border-b md:border-t-0 border-border overflow-hidden flex flex-col h-full md:h-auto md:max-h-[70vh] pointer-events-auto ${isIntegrated ?
                  "bg-popover rounded-b-xl shadow-xl shadow-black/5" :
                  "bg-popover/95 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_40px_100px_rgba(0,0,0,0.5)] max-w-[720px] md:rounded-[32px] rounded-t-[24px] mt-[10vh] md:mt-0"}`, children: [



                    !isIntegrated &&
                    _jsx("div", {
                      className: "p-4 pb-2", children:
                        _jsxs("div", {
                          className: "flex items-center px-4 h-12 md:h-14 bg-muted/30 border border-border focus-within:border-primary/40 focus-within:bg-popover transition-all duration-200 rounded-[16px] md:rounded-[18px]", children: [
                            ...
                            _jsx("button", {
                              onClick: onClose, className: "p-2 hover:bg-muted rounded-full transition-colors", children:
                    ...
                    _jsx("div", {
                      className: "px-4 md:px-6 py-3 border-b border-border", children:
                        _jsxs("div", {
                          className: "flex items-center gap-2 overflow-x-auto no-scrollbar", children: [
                    ...
                    _jsx("div", {
                      className: "flex-1 overflow-y-auto p-4 custom-scrollbar", children:
                        displayItems.map((group, groupIndex) =>
                          _jsxs("div", {
                            className: "mb-8 last:mb-2", children: [
                              _jsxs("div", {
                                className: "px-4 md:px-5 mb-2 md:mb-3 flex items-center justify-between", children: [
                                      ...
                                      _jsxs("button", {
                                        ...
                                        className: `w-full group/item flex items-center gap-3 md:gap-4 p-2.5 md:p-3 rounded-[16px] md:rounded-[20px] transition-all text-left relative overflow-hidden ${isSelected ?
                                          ...
                                          'hover:bg-muted/20'}`, children: [
                                            ...
                                            _jsx("div", {
                                              className: `p-2 md:p-2.5 rounded-lg md:rounded-xl transition-all duration-200 ${isSelected ?
                                            ...
                                            _jsxs("div", {
                                              className: "flex-1 flex flex-col min-w-0", children: [
                                                _jsx("div", {
                                                  className: "flex items-center gap-2", children:
                                                    _jsx("span", {
                                                      className: `text-[13px] md:text-[14px] font-medium transition-colors ${isSelected ? 'text-foreground' : 'text-muted-foreground'}`, children:
                                                        item.label
                                                    }
                                                    )
                                                }
                                                ...
                                                _jsx("p", {
                                                  className: `text-[11px] md:text-[12px] transition-colors mt-0.5 max-w-[480px] line-clamp-1 ${isSelected ? 'text-muted-foreground/80' : 'text-muted-foreground/40'}`, children:
                                                    item.desc
                                                }
                                                )]
                                            }
                    ...
                    _jsxs("div", {
                      className: "px-6 md:px-8 py-4 md:py-5 bg-muted/30 border-t border-border flex justify-between items-center mt-auto", children: [
                        _jsxs("div", {
                          className: "flex items-center gap-3 md:gap-5 text-[9px] md:text-[10px] font-medium text-muted-foreground uppercase tracking-widest", children: [
                            _jsxs("div", {
                              className: "flex items-center gap-1.5 md:gap-2", children: [
                        ...
                        _jsxs("button", {
                          className: "flex items-center gap-2 group/all text-primary", children: [
